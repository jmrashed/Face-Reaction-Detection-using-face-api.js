...
var detectionModel = faceapi.SsdMobilenetv1;
var expressionModel = faceapi.nets.ssdMobilenetv1;

// Load the models
Promise.all([detectionModel.loadFromUri('./models'), expressionModel.loadFromUri('./models')]).then(function () {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return faceapi.detectAllFaces(video, new detectionModel()).withFaceExpressions();
...
//# sourceMappingURL=/app.085cd0e9.map